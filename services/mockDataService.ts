...
export const mockBiProdutos: BiProduto[] = [
  { codigo: 'P01', nome: 'Respirador Volumétrico', descricao: 'Equipamento de suporte ventilatório pulmonar avançado.', custo: 120, preco_tabela: 300, lista_concatenada: 'P01 - Respirador Volumétrico' },
  { codigo: 'P02', nome: 'Monitor Multiparamétrico', descricao: 'Monitor de sinais vitais de alta resolução.', custo: 80, preco_tabela: 200, lista_concatenada: 'P02 - Monitor Multiparamétrico' },
  { codigo: 'P03', nome: 'Bomba de Infusão', descricao: 'Bomba infusora de seringa de alta precisão.', custo: 30, preco_tabela: 80, lista_concatenada: 'P03 - Bomba de Infusão' },
  { codigo: 'P04', nome: 'Desfibrilador Portátil', descricao: 'Desfibrilador externo automático bifásico.', custo: 150, preco_tabela: 350, lista_concatenada: 'P04 - Desfibrilador Portátil' },
];
...
export const mockBiVendas: BiVenda[] = [
  {
    id_tab: 'v01',
    fornecedor: 'F01 - Med Tech Brasil',
    cliente: 'C01 - Clínica São Lucas',
    produto: 'P01 - Respirador Volumétrico',
    qtd: 2,
    vlr_unit: 300,
    valor_total: 600,
    custo_prod: 120,
    ...
    data_retirada: '2026-08-10',
    data_devolucao: '2026-08-20',
    status_pagamento: 'Pago',
    status_aluguel: 'Devolvido',
  },
  {
    id_tab: 'v02',
    fornecedor: 'F02 - Health Equipamentos',
    cliente: 'C02 - Hospital Delta',
    produto: 'P02 - Monitor Multiparamétrico',
    qtd: 5,
    vlr_unit: 200,
    valor_total: 1000,
    custo_prod: 80,
  ...
  },
  {
    id_tab: 'v03',
    fornecedor: 'F01 - Med Tech Brasil',
    cliente: 'C03 - Centro Clínico Sul',
    produto: 'P01 - Respirador Volumétrico',
    qtd: 3,
    vlr_unit: 300,
    valor_total: 900,
    ...
    data_retirada: '2026-09-12',
    data_devolucao: '2026-09-22',
    status_pagamento: 'Pago',
    status_aluguel: 'Devolvido',
  },
  {
    id_tab: 'v04',
    fornecedor: 'F03 - Life Care Ltda',
    cliente: 'C04 - Laboratório Exame',
    produto: 'P03 - Bomba de Infusão',
    qtd: 10,
    vlr_unit: 80,
    valor_total: 800,
    custo_prod: 30,
    ...
    data: '2026-09-28',
    data_referencia: '2026-09-01',
    data_retirada: '2026-09-28',
    data_devolucao: '',
    status_pagamento: 'Pendente',
    status_aluguel: 'Não devolvido',
  },
  {
    id_tab: 'v05',
    fornecedor: 'F02 - Health Equipamentos',
  ...
  },
  {
    ...
    fornecedor: 'F03 - Life Care Ltda',
    cliente: 'C02 - Hospital Delta',
    produto: 'P04 - Desfibrilador Portátil',
    qtd: 2,
    vlr_unit: 350,
    valor_total: 700,
    custo_prod: 150,
  ...
  },
  {
    ...
    data_retirada: '2026-11-08',
    data_devolucao: '2026-11-18',
    status_pagamento: 'Pago',
    status_aluguel: 'Devolvido',
  },
  {
    ...
    data: '2026-11-22',
    data_referencia: '2026-11-01',
    data_retirada: '2026-11-22',
    data_devolucao: '',
    status_pagamento: 'Pendente',
    status_aluguel: 'Não retirado ainda',
  },
  {
    id_tab: 'v09',
    fornecedor: 'F01 - Med Tech Brasil',
    ...
    data_retirada: '2026-12-05',
    data_devolucao: '2026-12-15',
    status_pagamento: 'Pago',
    status_aluguel: 'Devolvido',
  },
  {
