...
export const LawyerProfile: React.FC<LawyerProfileProps> = ({ lawyer, onBack, onNavigate }) => {
  ...
  return (
    <>
      <div className="bg-white dark:text-white dark:bg-[#1A1730] dark:border-[#2A2545] dark:placeholder-gray-500 dark:caret-violet-500">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-1">
              <div className="bg-white p-6 rounded-lg shadow-lg border border-gray-100 sticky top-28 dark:text-white dark:bg-[#1A1730] dark:border-[#2A2545] dark:placeholder-gray-500 dark:caret-violet-500">
                ...
                <div className="mt-6">
                  {lawyer.consultationFee && (
                      <div className="text-center bg-emerald-50 p-3 rounded-lg">
                          <p className="text-sm text-emerald-700">Valor da consulta</p>
                          <p className="text-2xl font-bold text-emerald-800">R$ {lawyer.consultationFee},00</p>
                      </div>
                  )}
                  <button 
            ...
            <div className="lg:col-span-2">
              <div className="bg-white p-8 rounded-lg shadow-lg border border-gray-100 dark:text-white dark:bg-[#1A1730] dark:border-[#2A2545] dark:placeholder-gray-500 dark:caret-violet-500">
