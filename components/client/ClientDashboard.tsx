...
export const ClientDashboard: React.FC<ClientDashboardProps> = ({
  ...
  // ── Sidebar ──
  const renderSidebar = () => (
    <aside className="flex flex-col h-full bg-white dark:bg-[#1A1730] border-r border-gray-200 dark:border-[#2A2545] w-64 shrink-0 shadow-sm">
      {/* Logo area */}
      <div className="px-5 py-6 border-b border-gray-100 dark:border-[#2A2545]">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-2xl bg-gradient-to-br from-purple-500 to-indigo-600 flex items-center justify-center text-white font-extrabold text-lg shrink-0 shadow-md shadow-purple-600/20">
        ...
        {activeCase && (
          <button
            ...
            className="mt-3 w-full flex items-center gap-2 px-3 py-2 rounded-xl bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-900/30 text-purple-700 dark:text-purple-300 text-xs font-semibold hover:bg-purple-100 dark:hover:bg-purple-900/40 transition-colors"
          >
    ...
    <div className="flex h-screen bg-gray-50 dark:bg-[#0F0C1E] overflow-hidden">
      ...
      {sidebarOpen && (
        <div className="fixed inset-0 z-40 lg:hidden">
          ...
          <div className="absolute left-0 top-0 h-full w-64 z-50 animate-slide-in">
            {renderSidebar()}
          </div>
        </div>
      )}
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        {/* Scrollable content with subtle animation */}
        <main key={activeTab} className="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8 animate-fade-in">
