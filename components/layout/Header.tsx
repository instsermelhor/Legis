          ...
          <nav className="hidden md:flex items-center space-x-8">
             {user?.role !== 'admin' && (
                <>
                    ...
                    <a href="#" onClick={(e) => { e.preventDefault(); onNavigate('forLawyers'); }} className="text-gray-600 hover:text-primary transition duration-150 ease-in-out font-medium">Para Advogados</a>
                </>
             )}
              {user?.role === 'admin' && (
