          ...
          <nav className="hidden md:flex items-center">
            {user?.role !== 'admin' && (
              <>
                ...
                <a href="https://www.alphaconsensus.com.br" target="_blank" rel="noopener noreferrer" className="transition duration-150 ease-in-out font-medium ml-5 text-gray-600 hover:text-primary py-1 border-b-2 border-transparent">Câmara Arbitral e Mediações</a>
              </>
            )}
            {user?.role === 'admin' && (
