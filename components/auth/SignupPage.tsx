...
import { UserCircleIcon, BriefcaseIcon } from '../common/IconComponents';
            ...
            <div className="mt-12 max-w-2xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                >
                    ...
                    <p className="mt-2 text-gray-500">
                        Procurando por um advogado para resolver seu caso.
                    </p>
                </div>
                ...
                >
                    ...
                    <p className="mt-2 text-gray-500">
                        Querendo expandir sua carteira de clientes e gerenciar seus casos.
                    </p>
                </div>
            </div>
        </div>
