...
export const ShieldCheckIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 20.417l5.338-3.118A12.02 12.02 0 0012 18c2.68 0 5.17.933 7.162 2.528V12A9.97 9.97 0 0020.618 7.984z" />
  </svg>
);
...
export const QrcodeIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 5h3v3H5zM9 5h3v3H9zM5 9h3v3H5zM9 9h3v3H9zM13 5h3v3h-3zM17 5h3v3h-3zM13 9h3v3h-3zM17 9h3v3h-3zM13 13h3v3h-3zM17 13h3v3h-3zM5 13h3v3H5zM9 13h3v3H9zM5 17h3v3H5zM9 17h3v3H9zM13 17h3v3h-3zM17 17h3v3h-3z" />
    </svg>
);
...
// --- New SVG Icons for Emoji replacements ---
...
export const CourtIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const KeyIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15 7a2 2 0 012 2m-5 4a5 5 0 01-9-5 5 5 0 019 5zm0 0l5 5a.5.5 0 00.707 0l2-2a.5.5 0 000-.707L19 13l-4-4" />
  </svg>
);
...
export const ScaleIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3 6l3 1m0 0l-3 9a5.002 5.002 0 006.001 0l-3-9m3 1l3-1m9 1l3 1m0 0l-3 9a5.002 5.002 0 006.001 0l-3-9m3 1l3-1m-9 1v12m0 0h6m-6 0H6m6-16V4m0 0L9 6m3-2l3 2" />
  </svg>
);
...
export const FolderOpenIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2zM5 19a2 2 0 01-2-2V7a2 2 0 012-2h5l2 2h7a2 2 0 012 2v10a2 2 0 01-2 2H5z" />
  </svg>
);
...
export const HandWaveIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M14.828 14.828a4 4 0 01-5.656 0l-3-3a4 4 0 115.656-5.656l3 3a4 4 0 010 5.656z" />
  </svg>
);
...
export const Icon: React.FC<{ name: string; className?: string }> = ({ name, className = 'w-5 h-5' }) => {
  ...
  if (emojiMap[name]) {
    finalName = emojiMap[name];
  } else if (emojiMap[normName]) {
    finalName = emojiMap[normName];
  }

  switch (finalName) {
    case 'briefcase': return <BriefcaseIcon className={className} />;
    case 'user': return <UserCircleIcon className={className} />;
    case 'pin': return <PinIcon className={className} />;
    case 'paperclip': return <PaperClipIcon className={className} />;
    case 'check': return <BadgeCheckIcon className={className} />;
    ...
    case 'chevronleft': return <ChevronLeftIcon className={className} />;
    case 'chevronright': return <ChevronRightIcon className={className} />;
    case 'x': return <XIcon className={className} />;
    case 'paperairplane': return <PaperAirplaneIcon className={className} />;
    case 'download': return <DocumentDownloadIcon className={className} />;
    ...
    case 'invoice': return <ClipboardListIcon className={className} />;
    case 'money': return <CurrencyDollarIcon className={className} />;
    case 'pencil': return <PencilIcon className={className} />;
    case 'calendarplus': return <CalendarPlusIcon className={className} />;
    case 'chat': return <ChatBubbleIcon className={className} />;
    case 'shieldcheck': return <ShieldCheckIcon className={className} />;
    ...
    case 'crosshairs': return <CrosshairsIcon className={className} />;
    case 'robot': return <RobotIcon className={className} />;
    case 'court': return <CourtIcon className={className} />;
    ...
    case 'unlock': return <UnlockIcon className={className} />;
    ...
    case 'chart-up': return <TrendingUpIcon className={className} />;
    case 'chart-down': return <TrendingDownIcon className={className} />;
    ...
    case 'siren': return <SirenIcon className={className} />;
    case 'cart': return <ShoppingCartIcon className={className} />;
    case 'folder': return <FolderIcon className={className} />;
    case 'folder-open': return <FolderOpenIcon className={className} />;
    ...
    case 'stethoscope': return <StethoscopeIcon className={className} />;
    case 'crown': return <CrownIcon className={className} />;
    case 'wave': return <HandWaveIcon className={className} />;
    ...
    case 'warning': return <ExclamationIcon className={className} />;
