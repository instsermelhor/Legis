...
export type AuditAction =
  ...
  // Sistema, Tenancy & Catálogo de Módulos
  | 'CONFIG_CHANGED' | 'PERMISSION_DENIED' | 'RATE_LIMIT_HIT'
  | 'TENANT_CONTEXT_SWITCHED' | 'CROSS_TENANT_ACCESS_BLOCKED' | 'TENANT_VIOLATION_BLOCKED'
  | 'MODULE_ENABLED' | 'MODULE_DISABLED' | 'ENTITLEMENT_GRANTED' | 'ENTITLEMENT_REVOKED'
  | 'FEATURE_FLAG_CHANGED' | 'MODULE_ACCESS_BLOCKED'
  // Error Reporting & Incidentes
  | 'ERROR_REPORTED' | 'RUNTIME_EXCEPTION' | 'UNHANDLED_REJECTION'
  | 'REPORT_VIEWED' | 'REPORT_ASSIGNED' | 'REPORT_STATUS_CHANGED'
  | 'REPORT_RESOLVED' | 'REPORT_DELETED' | 'SECURITY_INCIDENT_FLAGGED';
