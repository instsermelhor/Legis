...
export const RBAC_MATRIX: FullMatrix = {
  ...
  super_admin: {
    ...
    roles:         { CREATE:'ALLOW',READ:'ALLOW',UPDATE:'ALLOW',DELETE:'ALLOW',DELEGATE:'ALLOW',REVOKE:'ALLOW',CONFIGURE:'ALLOW' },
    clients:       { CREATE:'ALLOW',READ:'ALLOW',UPDATE:'ALLOW',DELETE:'ALLOW',LIST:'ALLOW',SEARCH:'ALLOW',EXPORT:'ALLOW',ASSIGN:'ALLOW' },
    lawyers:       { CREATE:'ALLOW',READ:'ALLOW',UPDATE:'ALLOW',DELETE:'ALLOW',LIST:'ALLOW',SEARCH:'ALLOW',APPROVE:'ALLOW',REJECT:'ALLOW' },
    ...
    escrow:        { CREATE:'ALLOW',READ:'ALLOW',UPDATE:'ALLOW',DELETE:'ALLOW',RELEASE:'ALLOW',DISPUTE:'ALLOW',MANAGE:'ALLOW' },
    provisioning:  { READ:'ALLOW',LIST:'ALLOW',MANAGE:'ALLOW',CONFIGURE:'ALLOW' },
    services:      { READ:'ALLOW',MANAGE:'ALLOW',CONFIGURE:'ALLOW' },
    staff:         { CREATE:'ALLOW',READ:'ALLOW',UPDATE:'ALLOW',DELETE:'ALLOW',LIST:'ALLOW',DELEGATE:'ALLOW',REVOKE:'ALLOW' },
    registrations: { CREATE:'ALLOW',READ:'ALLOW',UPDATE:'ALLOW',DELETE:'ALLOW',LIST:'ALLOW',APPROVE:'ALLOW',REJECT:'ALLOW',EXPORT:'ALLOW' },
    audit:         { READ:'ALLOW',LIST:'ALLOW',EXPORT:'ALLOW',DELETE:'ALLOW',AUDIT:'ALLOW' },
    ai:            { READ:'ALLOW',MANAGE:'ALLOW',CONFIGURE:'ALLOW' },
    system:        { READ:'ALLOW',CONFIGURE:'ALLOW',AUDIT:'ALLOW',MANAGE:'ALLOW' },
  },
